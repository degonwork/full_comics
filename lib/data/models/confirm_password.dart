...
class ConfirmPassword extends FormzInput<String, ConfirmPasswordValidationError> {
  ...
  static final _confirmPasswordRegExp =  RegExp(r'^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$');
  @override
  ConfirmPasswordValidationError? validator(String? value){
    return _confirmPasswordRegExp.hasMatch(value ?? '') ? null : ConfirmPasswordValidationError.invalid;
  }
}