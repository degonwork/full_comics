  ...
  Widget build(BuildContext context) {
    return RepositoryProvider.value(
        ...
        child: MultiRepositoryProvider(
          providers: [
            RepositoryProvider(
                create: (context) => NewCommicRepo(apiClient: ApiClient())),
            RepositoryProvider(
                create: (context) => HotCommicRepo(apiClient: ApiClient())),
          ],
          child: MultiBlocProvider(
            providers: [
              ...
              BlocProvider<FetchNewMangaCubit>(
                  create: (context) => FetchNewMangaCubit(
                      newCommicRepo: context.read<NewCommicRepo>())
                    ..fetchNewManga()),
              BlocProvider<FetchHotCommicCubit>(
                  create: (context) => FetchHotCommicCubit(
                      hotMangaRepo: context.read<HotCommicRepo>())
                    ..fetchHotCommic()),
              BlocProvider(
